...
def render_clinical_pdf(
    ...
    *,
    ...
    lab_disclaimer = lab_disclaimer or (
        ...
        "Results have not been independently validated for diagnostic use and "
        "must be confirmed by orthogonal clinical-grade testing before any "
