...
### OMIM (requires free registration)
1. Register at https://omim.org/api and obtain API key
2. Download genemap2.txt from https://data.omim.org/downloads/<api_key>/genemap2.txt
3. Set in config:
```yaml
omim:
  genemap_path: "/data/omim/genemap2.txt"
```
