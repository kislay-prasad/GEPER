...
# hold. This constant is proposed but unratified, held uncommitted
# pending a clinical expert's ruling on the trilemma. The five failing
# tests represent current shipped behaviour rather than a defect.
#
# The question is with a clinical expert (board card
# kelly-classifier-denominator-fix-pp3-bp4, status `waiting`). Until
# answered, this change remains uncommitted. When the expert rules,
# EITHER repair option will be clear: lowering this constant to 1 makes
# PP3 and BP4 fire on the same variant, and editing those five tests
# decides a clinical rule by rewriting its evidence.
