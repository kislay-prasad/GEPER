...
#
# GEPER is a research pipeline, not a clinical diagnostic tool. That is
# the project's settled position and it is asserted consistently
# elsewhere -- `README.md`'s "Clinical disclaimer" section,
# `pipeline/explainability_engine.py`, `kim_pipeline/api/main.py`'s
# public API description ("For research use only. Not a clinical
# diagnostic tool"), and the CC BY-NC-SA 4.0 non-commercial-research
# licence the project ships under, which `DATA_SOURCE_LICENSE_AUDIT.md`
# leans on directly.
#
...
# separately-worded copy of this one. All three have been replaced by
# this constant. The final clause is the one genuinely useful sentence
# salvaged from the retired text.
#
...
RESEARCH_USE_DISCLAIMER = (
    ...
    "substitute for professional clinical genetic interpretation, diagnosis, or advice. All "
    "findings should be reviewed and confirmed by a qualified clinical geneticist or genetic "
    "counselor before any medical decision is made; clinical decisions must not be based "
