# GEPER Integrated Pipeline — Kim (FASTQ Engine) + Current GEPER (VCF Interpretation Engine)
...
```
geper_integrated/
├── geper/            Project A — current GEPER. UNCHANGED. Remains the sole,
...
### 3. Run GEPER directly against an existing VCF (unchanged)
```bash
cd geper
